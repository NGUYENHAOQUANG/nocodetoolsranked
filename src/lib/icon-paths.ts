...
/**
 * Dấu × để đóng, viewBox 0 0 24 24, đầu nét bo tròn.
 *
 * Dùng ở drawer mobile (`Header`) và popup exit-intent (`ExitPopup`). Chuyển vào
 * đây khi có chỗ dùng thứ hai — trước đó nó nằm nguyên trong `Header`, đúng quy
 * tắc ở đầu file.
 */
